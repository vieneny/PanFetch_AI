...
class AssistantPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.delete_chat_button.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_TrashIcon))
        self.delete_chat_button.setToolTip("删除选中的 AI 对话")
        self.delete_chat_button.setProperty("danger", True)
        self.delete_chat_button.setFixedSize(32, 32)
        ...
        history_header.addWidget(self.delete_chat_button)
